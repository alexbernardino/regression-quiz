...
export default function Home() {
  ...
  return <main className="quiz-shell">
    ...
    <section className="quiz-layout">
      ...
      <section className="question-stage"><p className="setup-note"><strong>Demo setup:</strong> Use automatically generated normal points from y = β₀ + β₁x with independent, zero-mean noise of constant variance. Keep both penalty sliders at zero and use a nonzero x range. No outliers or manually added points unless requested. Noise need not be zero.</p><div className="progress-row"><span>Question {current+1} of {questions.length}</span><div className="progress-track"><div style={{width:`${(current+1)/questions.length*100}%`}}/></div><strong>{score} points</strong></div>
